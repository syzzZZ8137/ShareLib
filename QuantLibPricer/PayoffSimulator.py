...
def get_PV_payoffs(paths, interest_rate, strike_floor, strike_premium):
    ...
    for i in range(len(paths)):
        PV_payoff_i = get_PV_payoff_by_path(paths[i], interest_rate, strike_floor, strike_premium)
...
#    volatility = 0.4
    ...
    PV_payoffs = get_PV_payoffs(paths, interest_rate, strike_floor, strike_premium)
